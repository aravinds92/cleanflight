...
void mwDisarm(void);
# 60 "src/main/flight/imu.c" 2
# 74 "src/main/flight/imu.c"
int16_t accSmooth[3];
int32_t accSum[3];
...
static 
# 91 "src/main/flight/imu.c" 3 4
      _Bool 
# 91 "src/main/flight/imu.c"
...
# 96 "src/main/flight/imu.c" 3 4
_Bool 
# 96 "src/main/flight/imu.c"
...
)
{
    if(!runtimeConfig_initialized)
    {
        ...
        runtimeConfig_initialized = 
# 159 "src/main/flight/imu.c" 3 4
                                   1
# 159 "src/main/flight/imu.c"
                                       ;
    }
...
# 271 "src/main/flight/imu.c" 3 4
                               _Bool 
# 271 "src/main/flight/imu.c"
                                    useAcc, float ax, float ay, float az,
                                
# 272 "src/main/flight/imu.c" 3 4
                               _Bool 
# 272 "src/main/flight/imu.c"
                                    useMag, float mx, float my, float mz,
                                
# 273 "src/main/flight/imu.c" 3 4
                               _Bool 
# 273 "src/main/flight/imu.c"
...
# 401 "src/main/flight/imu.c" 3 4
_Bool 
# 401 "src/main/flight/imu.c"
    imuIsAircraftArmable(uint8_t arming_angle)
{
...
static 
# 430 "src/main/flight/imu.c" 3 4
      _Bool 
# 430 "src/main/flight/imu.c"
...
# 442 "src/main/flight/imu.c" 3 4
   _Bool 
# 442 "src/main/flight/imu.c"
        useAcc = 
# 442 "src/main/flight/imu.c" 3 4
                 0
# 442 "src/main/flight/imu.c"
...
# 443 "src/main/flight/imu.c" 3 4
   _Bool 
# 443 "src/main/flight/imu.c"
        useMag = 
# 443 "src/main/flight/imu.c" 3 4
                 0
# 443 "src/main/flight/imu.c"
...
# 444 "src/main/flight/imu.c" 3 4
   _Bool 
# 444 "src/main/flight/imu.c"
        useYaw = 
# 444 "src/main/flight/imu.c" 3 4
                 0
# 444 "src/main/flight/imu.c"
...
# 460 "src/main/flight/imu.c"
    ...
    if (sensors(SENSOR_MAG) && isMagnetometerHealthy()) {
        useMag = 
# 465 "src/main/flight/imu.c" 3 4
                1
# 465 "src/main/flight/imu.c"
                    ;
    }
# 477 "src/main/flight/imu.c"
...
void imuUpdateAccelerometer(rollAndPitchTrims_t *accelerometerTrims)
{
        ...
        isAccelUpdatedAtLeastOnce = 
# 494 "src/main/flight/imu.c" 3 4
                                   1
# 494 "src/main/flight/imu.c"
                                       ;
}
...
void MadgwickQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
{
  ...
  qDot1 = 0.5f * (-qb * gx - qc * gy - qd * gz) - 0.04f * s1;
  qDot2 = 0.5f * (qa * gx + qc * gz - qd * gy) - 0.04f * s2;
  qDot3 = 0.5f * (qa * gy - qb * gz + qd * gx) - 0.04f * s3;
  qDot4 = 0.5f * (qa * gz + qb * gy - qc * gx) - 0.04f * s4;
