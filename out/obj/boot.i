...
# 22 "./src/main/drivers/gyro_sync.h" 3 4
_Bool 
# 22 "./src/main/drivers/gyro_sync.h"
...
# 20 "./src/main/drivers/accgyro.h" 2
...
# 20 "./src/main/sensors/acceleration.h" 2
...
# 21 "./src/main/sensors/acceleration.h" 2
...
# 763 "src/main/fc/boot.c"
void configureScheduler(void)
{
    schedulerInit();
    setTaskEnabled(TASK_SYSTEM, 
# 766 "src/main/fc/boot.c" 3 4
                               1
# 766 "src/main/fc/boot.c"
                                   );
    setTaskEnabled(TASK_SERIAL, 
# 767 "src/main/fc/boot.c" 3 4
                               1
# 767 "src/main/fc/boot.c"
                                   );

    setTaskEnabled(TASK_COMPASS, 
# 769 "src/main/fc/boot.c" 3 4
                                1
# 769 "src/main/fc/boot.c"
                                    );

    setTaskEnabled(TASK_ACCEL, 
# 771 "src/main/fc/boot.c" 3 4
                              1
# 771 "src/main/fc/boot.c"
                                  );
    setTaskEnabled(TASK_GYROPID, 
# 772 "src/main/fc/boot.c" 3 4
                                1
# 772 "src/main/fc/boot.c"
                                    );
# 812 "src/main/fc/boot.c"
}
...
void init(void)
{
    ...
    configureScheduler();
    serialInit(
# 847 "src/main/fc/boot.c" 3 4
              1
# 847 "src/main/fc/boot.c"
                  );
    mspInit();
    mspSerialInit();
    activateConfig();
...
int main(void)
{
    ...
    while (
# 867 "src/main/fc/boot.c" 3 4
          1
# 867 "src/main/fc/boot.c"
              )
    {
        scheduler();
    }
