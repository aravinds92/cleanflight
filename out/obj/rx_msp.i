...
# 36 "src/main/rx/rx_msp.c" 2

static uint16_t mspFrame[(18)];
static 
# 38 "src/main/rx/rx_msp.c" 3 4
      _Bool 
# 38 "src/main/rx/rx_msp.c"
           rxMspFrameDone = 
# 38 "src/main/rx/rx_msp.c" 3 4
                            0
# 38 "src/main/rx/rx_msp.c"
...
void rxMspFrameReceive(uint16_t *frame, int channelCount)
{
    ...
    rxMspFrameDone = 
# 57 "src/main/rx/rx_msp.c" 3 4
                    1
# 57 "src/main/rx/rx_msp.c"
                        ;
}


# 60 "src/main/rx/rx_msp.c" 3 4
_Bool 
# 60 "src/main/rx/rx_msp.c"
    rxMspFrameComplete(void)
{
    if (!rxMspFrameDone) {
        return 
# 63 "src/main/rx/rx_msp.c" 3 4
              0
# 63 "src/main/rx/rx_msp.c"
                   ;
    }

    rxMspFrameDone = 
# 66 "src/main/rx/rx_msp.c" 3 4
                    0
# 66 "src/main/rx/rx_msp.c"
                         ;
    return 
# 67 "src/main/rx/rx_msp.c" 3 4
          1
# 67 "src/main/rx/rx_msp.c"
              ;
}
