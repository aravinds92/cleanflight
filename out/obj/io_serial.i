...
# 31 "src/main/io/io_serial.c" 2
# 1 "./src/main/config/parameter_group_ids.h" 1
# 32 "src/main/io/io_serial.c" 2
...
# 29 "./src/main/drivers/serial_usb_vcp.h" 3 4
   _Bool 
# 29 "./src/main/drivers/serial_usb_vcp.h"
        buffering;
} vcpPort_t;
extern volatile uint32_t receiveLength;
serialPort_t *usbVcpOpen(void);
uint32_t usbVcpGetBaudRate(serialPort_t *instance);
# 46 "src/main/io/io_serial.c" 2
...
static serialPortUsage_t serialPortUsageList[2];

const serialPortIdentifier_e serialPortIdentifiers[2] = {

    SERIAL_PORT_USB_VCP,
# 86 "src/main/io/io_serial.c"
};
...
static serialPortUsage_t *findSerialPortUsageByIdentifier(serialPortIdentifier_e identifier)
{
    ...
    return 
# 115 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 115 "src/main/io/io_serial.c"
              ;
}
...
serialPortUsage_t *findSerialPortUsageByPort(serialPort_t *serialPort)
{
    ...
    return 
# 127 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 127 "src/main/io/io_serial.c"
              ;
}
...
serialPortConfig_t *findNextSerialPortConfig(uint16_t mask)
{
    while (findSerialPortConfigState.lastIndex < 2) {
    ...
    return 
# 151 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 151 "src/main/io/io_serial.c"
              ;
}
...
# 166 "src/main/io/io_serial.c" 3 4
_Bool 
# 166 "src/main/io/io_serial.c"
    isSerialPortShared(serialPortConfig_t *portConfig, uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
...
# 171 "src/main/io/io_serial.c" 3 4
_Bool 
# 171 "src/main/io/io_serial.c"
    isSerialPortOpen(serialPortConfig_t *portConfig)
{
...
serialPort_t *findNextSharedSerialPort(uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
    while (findSharedSerialPortState.lastIndex < 2) {
    ...
    return 
# 200 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 200 "src/main/io/io_serial.c"
              ;
}
...
# 206 "src/main/io/io_serial.c" 3 4
_Bool 
# 206 "src/main/io/io_serial.c"
    isSerialConfigValid(serialConfig_t *serialConfigToCheck)
{
    ...
    for (index = 0; index < 2; index++) {
        ...
        if (bitCount > 1) {
            ...
            if (bitCount > 2) {
                return 
# 229 "src/main/io/io_serial.c" 3 4
                      0
# 229 "src/main/io/io_serial.c"
                           ;
            }

            if (!(portConfig->functionMask & FUNCTION_MSP_SERVER)) {
                return 
# 233 "src/main/io/io_serial.c" 3 4
                      0
# 233 "src/main/io/io_serial.c"
                           ;
            }

            if (!(portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK)))) {

                return 
# 238 "src/main/io/io_serial.c" 3 4
                      0
# 238 "src/main/io/io_serial.c"
                           ;
            }
        }
    }
    ...
    if (mspPortCount == 0 || mspPortCount > 2) {
        return 
# 244 "src/main/io/io_serial.c" 3 4
              0
# 244 "src/main/io/io_serial.c"
                   ;
    }
    return 
# 246 "src/main/io/io_serial.c" 3 4
          1
# 246 "src/main/io/io_serial.c"
              ;
}
...
serialPortConfig_t *serialFindPortConfiguration(serialPortIdentifier_e identifier)
{
    ...
    return 
# 258 "src/main/io/io_serial.c" 3 4
          ((void *)0)
# 258 "src/main/io/io_serial.c"
              ;
}


# 261 "src/main/io/io_serial.c" 3 4
_Bool 
# 261 "src/main/io/io_serial.c"
    doesConfigurationUsePort(serialPortIdentifier_e identifier)
{
    ...
    return candidate != 
# 264 "src/main/io/io_serial.c" 3 4
                       ((void *)0) 
# 264 "src/main/io/io_serial.c"
    ...
    portOptions_t options)
{
    ...
    if (!serialPortUsage || serialPortUsage->function != FUNCTION_NONE) {
        ...
        return 
# 285 "src/main/io/io_serial.c" 3 4
              ((void *)0)
# 285 "src/main/io/io_serial.c"
                  ;
    }

    serialPort_t *serialPort = 
# 288 "src/main/io/io_serial.c" 3 4
                              ((void *)0)
# 288 "src/main/io/io_serial.c"
                                  ;
    switch(identifier) {
...
# 332 "src/main/io/io_serial.c"
    ...
    if (!serialPort) {
        return 
# 337 "src/main/io/io_serial.c" 3 4
              ((void *)0)
# 337 "src/main/io/io_serial.c"
                  ;
    }
...
void closeSerialPort(serialPort_t *serialPort)
{
    ...
    serialPort->callback = 
# 359 "src/main/io/io_serial.c" 3 4
                          ((void *)0)
# 359 "src/main/io/io_serial.c"
                              ;

    serialPortUsage->function = FUNCTION_NONE;
    serialPortUsage->serialPort = 
# 362 "src/main/io/io_serial.c" 3 4
                                 ((void *)0)
# 362 "src/main/io/io_serial.c"
                                     ;
}

void serialInit(
# 365 "src/main/io/io_serial.c" 3 4
               _Bool 
# 365 "src/main/io/io_serial.c"
                    softserialEnabled)
{
    uint8_t index;
...
# 413 "src/main/io/io_serial.c" 3 4
_Bool 
# 413 "src/main/io/io_serial.c"
    serialIsPortAvailable(serialPortIdentifier_e identifier)
{
    for (uint8_t index = 0; index < 2; index++) {
        if (serialPortUsageList[index].identifier == identifier) {
            return 
# 417 "src/main/io/io_serial.c" 3 4
                  1
# 417 "src/main/io/io_serial.c"
                      ;
        }
    }
    return 
# 420 "src/main/io/io_serial.c" 3 4
          0
# 420 "src/main/io/io_serial.c"
               ;
}
