...
.LFB11:
	...
	.loc 1 108 0
	movq	imu(%rip), %rax	# imu, D.6017
	movq	%rax, %rdi	# D.6017,
	call	readMag	#
	.loc 1 110 0
	movq	imu(%rip), %rax	# imu, D.6017
	movzwl	12(%rax), %edx	# _4->mx, D.6018
	movq	-8(%rbp), %rax	# magData, tmp98
	movw	%dx, (%rax)	# D.6018, *magData_6(D)
	.loc 1 111 0
	movq	-8(%rbp), %rax	# magData, tmp99
	leaq	2(%rax), %rdx	#, D.6019
	movq	imu(%rip), %rax	# imu, D.6017
	movzwl	14(%rax), %eax	# _9->my, D.6018
	movw	%ax, (%rdx)	# D.6018, *_8
	.loc 1 112 0
	movq	-8(%rbp), %rax	# magData, tmp100
	leaq	4(%rax), %rdx	#, D.6019
	movq	imu(%rip), %rax	# imu, D.6017
	movzwl	16(%rax), %eax	# _13->mz, D.6018
	movw	%ax, (%rdx)	# D.6018, *_12
	.loc 1 146 0
	movl	$1, %eax	#, D.6020
	.loc 1 147 0
	leave
...
.Letext0:
	...
	.file 7 "src/main/drivers/drivers_compass.h"
