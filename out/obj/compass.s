...
.LFB15:
	...
	.loc 1 37 0
	movq	compassConfig_ProfileCurrent(%rip), %rax	# compassConfig_ProfileCurrent, D.3705
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LFB16:
	...
	call	puts	#
	.loc 2 75 0
	movq	mag(%rip), %rax	# mag.init, D.3706
	call	*%rax	# D.3706
...
.LFB17:
	...
	.loc 2 90 0
	movq	mag+8(%rip), %rax	# mag.read, D.3710
	movl	$magADCRaw, %edi	#,
	call	*%rax	# D.3710
	xorl	$1, %eax	#, D.3711
	testb	%al, %al	# D.3711
...
.L10:
	...
	cltq
	movzwl	magADCRaw(%rax,%rax), %eax	# magADCRaw, D.3712
	movswl	%ax, %edx	# D.3712, D.3713
	movl	-16(%rbp), %eax	# axis, tmp142
	cltq
	movl	%edx, magADC(,%rax,4)	# D.3713, magADC
...
.LBE2:
	...
	movl	magAlign(%rip), %eax	# magAlign, D.3714
	movzbl	%al, %eax	# D.3715, D.3713
	movl	%eax, %edx	# D.3713,
	movl	$magADC, %esi	#,
	movl	$magADC, %edi	#,
	call	alignSensors	#
	.loc 2 98 0
	movzbl	stateFlags(%rip), %eax	# stateFlags, D.3715
	movzbl	%al, %eax	# D.3715, D.3713
	andl	$4, %eax	#, D.3713
	testl	%eax, %eax	# D.3713
	je	.L11	#,
	.loc 2 99 0
	movl	currentTime(%rip), %eax	# currentTime, D.3716
	movl	%eax, tCal.3588(%rip)	# D.3716, tCal
.LBB3:
	.loc 2 100 0
	movl	$0, -12(%rbp)	#, axis
	jmp	.L12	#
.L13:
	...
	cltq
	movl	magADC(,%rax,4), %eax	# magADC, D.3713
	movl	%eax, %edx	# D.3713, D.3712
	movl	-12(%rbp), %eax	# axis, tmp149
	cltq
	movw	%dx, magZeroTempMin.3589(%rax,%rax)	# D.3712, magZeroTempMin.raw
	...
	cltq
	movw	%dx, magZeroTempMax.3590(%rax,%rax)	# D.3712, magZeroTempMax.raw
...
.LBE3:
	...
	movzbl	stateFlags(%rip), %eax	# stateFlags, D.3715
	andl	$-5, %eax	#, D.3715
	movb	%al, stateFlags(%rip)	# D.3715, stateFlags
.L11:
	.loc 2 108 0
	movzbl	magInit(%rip), %eax	# magInit, D.3715
	testb	%al, %al	# D.3715
	je	.L14	#,
	.loc 2 109 0
	movl	magADC(%rip), %edx	# magADC, D.3713
	movq	-24(%rbp), %rax	# magZero, tmp154
	movzwl	(%rax), %eax	# magZero_34(D)->raw, D.3712
	cwtl
	subl	%eax, %edx	# D.3713, D.3713
	movl	%edx, %eax	# D.3713, D.3713
	movl	%eax, magADC(%rip)	# D.3713, magADC
	.loc 2 110 0
	movl	magADC+4(%rip), %edx	# magADC, D.3713
	movq	-24(%rbp), %rax	# magZero, tmp155
	movzwl	2(%rax), %eax	# magZero_34(D)->raw, D.3712
	cwtl
	subl	%eax, %edx	# D.3713, D.3713
	movl	%edx, %eax	# D.3713, D.3713
	movl	%eax, magADC+4(%rip)	# D.3713, magADC
	.loc 2 111 0
	movl	magADC+8(%rip), %edx	# magADC, D.3713
	movq	-24(%rbp), %rax	# magZero, tmp156
	movzwl	4(%rax), %eax	# magZero_34(D)->raw, D.3712
	cwtl
	subl	%eax, %edx	# D.3713, D.3713
	movl	%edx, %eax	# D.3713, D.3713
	movl	%eax, magADC+8(%rip)	# D.3713, magADC
.L14:
	.loc 2 114 0
	movl	tCal.3588(%rip), %eax	# tCal, D.3716
	testl	%eax, %eax	# D.3716
	je	.L6	#,
	.loc 2 115 0
	movl	currentTime(%rip), %edx	# currentTime, D.3716
	movl	tCal.3588(%rip), %eax	# tCal, D.3716
	subl	%eax, %edx	# D.3716, D.3716
	movl	%edx, %eax	# D.3716, D.3716
	cmpl	$29999999, %eax	#, D.3716
	ja	.L15	#,
	.loc 2 117 0
	movl	$.LC2, %edi	#,
	call	puts	#
...
.L19:
	...
	cltq
	movl	magADC(,%rax,4), %edx	# magADC, D.3713
	movl	-8(%rbp), %eax	# axis, tmp160
	cltq
	movzwl	magZeroTempMin.3589(%rax,%rax), %eax	# magZeroTempMin.raw, D.3712
	cwtl
	cmpl	%eax, %edx	# D.3713, D.3713
	jge	.L17	#,
	.loc 2 120 0
...
.L17:
	...
	cltq
	movzwl	magZeroTempMax.3590(%rax,%rax), %eax	# magZeroTempMax.raw, D.3712
	cwtl
	cmpl	%eax, %edx	# D.3713, D.3713
	jle	.L18	#,
	.loc 2 122 0
...
.L21:
	...
	movzwl	magZeroTempMax.3590(%rax,%rax), %eax	# magZeroTempMax.raw, D.3712
	cwtl
	addl	%edx, %eax	# D.3713, D.3713
	movl	%eax, %edx	# D.3713, tmp177
	shrl	$31, %edx	#, tmp177
	addl	%edx, %eax	# tmp177, tmp178
	sarl	%eax	# tmp179
	movl	%eax, %ecx	# D.3713, D.3712
	movq	-24(%rbp), %rax	# magZero, tmp180
	movl	-4(%rbp), %edx	# axis, tmp182
	movslq	%edx, %rdx	# tmp182, tmp181
	movw	%cx, (%rax,%rdx,2)	# D.3712, magZero_34(D)->raw
...
.LFB18:
	...
	.loc 2 142 0
	call	compassConfig	#
	movzwl	(%rax), %eax	# _6->mag_declination, D.3720
	movswl	%ax, %edx	# D.3720, tmp97
	...
	.loc 2 143 0
	call	compassConfig	#
	movzwl	(%rax), %edx	# _10->mag_declination, D.3720
	movswl	%dx, %eax	# D.3720, tmp103
	imull	$5243, %eax, %eax	#, tmp103, tmp104
	shrl	$16, %eax	#, tmp105
	movl	%eax, %ecx	# tmp105, tmp106
	sarw	$3, %cx	#, tmp106
	movl	%edx, %eax	# D.3720, tmp107
	sarw	$15, %ax	#, tmp107
	...
	pxor	%xmm1, %xmm1	# D.3721
	cvtsi2ss	%eax, %xmm1	# tmp114, D.3721
	movswl	-2(%rbp), %eax	# min, tmp115
	pxor	%xmm0, %xmm0	# D.3721
	cvtsi2ss	%eax, %xmm0	# tmp115, D.3721
	movss	.LC3(%rip), %xmm2	#, tmp116
	mulss	%xmm2, %xmm0	# tmp116, D.3721
	addss	%xmm1, %xmm0	# D.3721, D.3721
	movss	.LC4(%rip), %xmm1	#, tmp117
	mulss	%xmm1, %xmm0	# tmp117, D.3721
	movss	%xmm0, magneticDeclination(%rip)	# D.3721, magneticDeclination
	.loc 2 150 0
	jmp	.L26	#
.L24:
	.loc 2 147 0
...
.LFE18:
	...
	.section	.bss.tCal.3588,"aw",@nobits
	.align 4
	.type	tCal.3588, @object
	.size	tCal.3588, 4
tCal.3588:
	.zero	4
	.section	.bss.magZeroTempMin.3589,"aw",@nobits
	.align 2
	.type	magZeroTempMin.3589, @object
	.size	magZeroTempMin.3589, 6
magZeroTempMin.3589:
	.zero	6
	.section	.bss.magZeroTempMax.3590,"aw",@nobits
	.align 2
	.type	magZeroTempMax.3590, @object
	.size	magZeroTempMax.3590, 6
magZeroTempMax.3590:
	.zero	6
	.section	.rodata
	.align 4
