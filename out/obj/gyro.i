...
void warningLedBeeper(
# 22 "./src/main/io/statusindicator.h" 3 4
                     _Bool 
# 22 "./src/main/io/statusindicator.h"
                          on);
...
static 
# 58 "src/main/sensors/gyro.c" 3 4
      _Bool 
# 58 "src/main/sensors/gyro.c"
           gyroFilterStateIsSet;


# 60 "src/main/sensors/gyro.c" 3 4
_Bool 
# 60 "src/main/sensors/gyro.c"
    gyro_initialized = 
# 60 "src/main/sensors/gyro.c" 3 4
                       0
# 60 "src/main/sensors/gyro.c"
...
void pgResetFn_gyroConfig(void)
{
        gyroConfig->gyro_lpf = 0;
        gyroConfig->soft_gyro_lpf_hz = 100;
...
static void initGyroFilterCoefficients(void)
{
    if (gyroConfig->soft_gyro_lpf_hz) {
        ...
        gyroFilterStateIsSet = 
# 79 "src/main/sensors/gyro.c" 3 4
                              1
# 79 "src/main/sensors/gyro.c"
                                  ;
    }
}
...
# 88 "src/main/sensors/gyro.c" 3 4
_Bool 
# 88 "src/main/sensors/gyro.c"
    isGyroCalibrationComplete(void)
{
...
static 
# 93 "src/main/sensors/gyro.c" 3 4
      _Bool 
# 93 "src/main/sensors/gyro.c"
           isOnFinalGyroCalibrationCycle(void)
{
    return calibratingG == 1;
}

static 
# 98 "src/main/sensors/gyro.c" 3 4
      _Bool 
# 98 "src/main/sensors/gyro.c"
           isOnFirstGyroCalibrationCycle(void)
{
...
void gyroUpdate(void)
{
    ...
    if(!gyro_initialized)
    {
        ...
        gyro_initialized = 
# 154 "src/main/sensors/gyro.c" 3 4
                          1
# 154 "src/main/sensors/gyro.c"
                              ;
    }
