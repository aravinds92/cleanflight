...
.LFB56:
	...
	.loc 1 92 0
	movl	$mixerConfig_System, %eax	#, D.8896
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
...
.LBB3:
	...
	movzbl	8(%rax), %eax	# candidate_4->boxId, D.8928
	cmpb	-20(%rbp), %al	# boxId, D.8928
	jne	.L5	#,
	.loc 2 230 0
	movq	-8(%rbp), %rax	# candidate, D.8927
	jmp	.L6	#
.L5:
.LBE3:
...
.LBB5:
	...
	.loc 2 240 0
	movq	-8(%rbp), %rax	# candidate, tmp94
	movzbl	9(%rax), %eax	# candidate_4->permanentId, D.8930
	cmpb	-20(%rbp), %al	# permanentId, D.8930
	jne	.L10	#,
	.loc 2 241 0
...
.LBB7:
	...
	sall	%cl, %edx	# tmp103, D.8931
	movl	%edx, %eax	# D.8931, D.8931
	movl	%eax, %edx	# D.8931, D.8932
	movl	activeBoxIds(%rip), %eax	# activeBoxIds, D.8932
	andl	%edx, %eax	# D.8932, D.8932
	testl	%eax, %eax	# D.8932
	je	.L18	#,
	.loc 2 253 0
	movl	-20(%rbp), %eax	# i, tmp97
	movzbl	%al, %eax	# D.8933, D.8931
	movl	%eax, %edi	# D.8931,
	call	findBoxByBoxId	#
	movq	%rax, -8(%rbp)	# tmp98, box
	.loc 2 254 0
	movq	-8(%rbp), %rax	# box, tmp99
	movq	(%rax), %rdx	# box_15->boxName, D.8934
...
.LBB9:
	...
	sall	%cl, %edx	# tmp103, D.8935
	movl	%edx, %eax	# D.8935, D.8935
	movl	%eax, %edx	# D.8935, D.8936
	movl	activeBoxIds(%rip), %eax	# activeBoxIds, D.8936
	andl	%edx, %eax	# D.8936, D.8936
	testl	%eax, %eax	# D.8936
	je	.L24	#,
	.loc 2 266 0
	movl	-20(%rbp), %eax	# i, tmp98
	movzbl	%al, %eax	# D.8937, D.8935
	movl	%eax, %edi	# D.8935,
	call	findBoxByBoxId	#
	movq	%rax, -8(%rbp)	# tmp99, box
	.loc 2 267 0
	movq	-8(%rbp), %rax	# box, tmp100
	movzbl	9(%rax), %eax	# box_15->permanentId, D.8937
	movzbl	%al, %edx	# D.8937, D.8935
	movq	-16(%rbp), %rax	# dst, tmp101
	movl	%edx, %esi	# D.8935,
	movq	%rax, %rdi	# tmp101,
	call	sbufWriteU8	#
...
.L29:
	.loc 2 308 0
	call	mixerConfig	#
	movzbl	(%rax), %eax	# _36->mixerMode, D.8940
	cmpb	$8, %al	#, D.8940
	je	.L30	#,
	.loc 2 309 0
	call	mixerConfig	#
	movzbl	(%rax), %eax	# _39->mixerMode, D.8940
	cmpb	$14, %al	#, D.8940
	je	.L30	#,
	.loc 2 310 0
	call	mixerConfig	#
	movzbl	(%rax), %eax	# _42->mixerMode, D.8940
	cmpb	$24, %al	#, D.8940
	jne	.L31	#,
.L30:
	.loc 2 311 0
...
.L37:
	...
	sall	%cl, %edx	# tmp116, D.8941
	movl	%edx, %eax	# D.8941, D.8941
	andl	-8(%rbp), %eax	# ena, D.8942
	testl	%eax, %eax	# D.8942
	je	.L36	#,
	.loc 2 363 0
	movl	-4(%rbp), %eax	# boxId, tmp111
	movzbl	%al, %eax	# D.8940, D.8941
	movl	%eax, %edi	# D.8941,
	call	findBoxByBoxId	#
	testq	%rax, %rax	# D.8943
	jne	.L36	#,
	.loc 2 364 0
	movl	-4(%rbp), %eax	# boxId, tmp112
	movl	$1, %edx	#, tmp113
	movl	%eax, %ecx	# tmp112, tmp118
	sall	%cl, %edx	# tmp118, D.8941
	movl	%edx, %eax	# D.8941, D.8941
	notl	%eax	# D.8941
	andl	%eax, -8(%rbp)	# D.8942, ena
.L36:
...
.L43:
	...
	movzbl	flightMode_boxId_map.8586(%rax), %eax	# flightMode_boxId_map, D.8944
	cmpb	$-1, %al	#, D.8944
	je	.L55	#,
	.loc 2 384 0
	...
	sall	%cl, %edx	# tmp138, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	andl	-8(%rbp), %eax	# flightModeCopyMask, D.8946
	testl	%eax, %eax	# D.8946
	je	.L56	#,
	.loc 2 386 0
	movzwl	flightModeFlags(%rip), %eax	# flightModeFlags, D.8947
	movzwl	%ax, %edx	# D.8947, D.8945
	movl	-28(%rbp), %eax	# i, tmp122
	movl	%eax, %ecx	# tmp122, tmp140
	sarl	%cl, %edx	# tmp140, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	andl	$1, %eax	#, D.8945
	testl	%eax, %eax	# D.8945
	je	.L41	#,
	.loc 2 387 0
	movl	-28(%rbp), %eax	# i, tmp123
	movzbl	flightMode_boxId_map.8586(%rax), %eax	# flightMode_boxId_map, D.8944
	movsbl	%al, %eax	# D.8944, D.8945
	movl	$1, %edx	#, tmp124
	movl	%eax, %ecx	# D.8945, tmp142
	sall	%cl, %edx	# tmp142, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	orl	%eax, -32(%rbp)	# D.8946, boxEnabledMask
	jmp	.L41	#
.L55:
	.loc 2 383 0
	nop
...
.L47:
	...
	sall	%cl, %edx	# tmp144, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	andl	-4(%rbp), %eax	# rcModeCopyMask, D.8946
	testl	%eax, %eax	# D.8946
	je	.L57	#,
	.loc 2 399 0
...
.LBE12:
	...
	movzbl	armingFlags(%rip), %eax	# armingFlags, D.8949
	movzbl	%al, %eax	# D.8949, D.8945
	andl	$4, %eax	#, D.8945
	testl	%eax, %eax	# D.8945
	je	.L48	#,
	.loc 2 405 0
...
.L53:
	...
	sall	%cl, %edx	# tmp148, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	movl	%eax, %edx	# D.8945, D.8946
	movl	activeBoxIds(%rip), %eax	# activeBoxIds, D.8946
	andl	%edx, %eax	# D.8946, D.8946
	testl	%eax, %eax	# D.8946
	je	.L58	#,
	.loc 2 414 0
	...
	sall	%cl, %edx	# tmp150, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	andl	-32(%rbp), %eax	# boxEnabledMask, D.8946
	testl	%eax, %eax	# D.8946
	je	.L52	#,
	.loc 2 415 0
	...
	sall	%cl, %edx	# tmp152, D.8945
	movl	%edx, %eax	# D.8945, D.8945
	orl	%eax, -20(%rbp)	# D.8946, mspBoxEnabledMask
.L52:
	.loc 2 416 0
...
.LBE13:
	...
	movl	-20(%rbp), %eax	# mspBoxEnabledMask, D.8950
	.loc 2 419 0
	leave
	.cfi_def_cfa 7, 8
	ret
...
.LFB75:
	...
	.loc 2 503 0
	movq	-80(%rbp), %rax	# reply, tmp173
	movq	%rax, -32(%rbp)	# tmp173, dst
	.loc 2 504 0
	movq	-72(%rbp), %rax	# cmd, tmp174
	movq	%rax, -24(%rbp)	# tmp174, src
	.loc 2 510 0
	movq	-24(%rbp), %rax	# src, tmp175
	movq	%rax, %rdi	# tmp175,
	call	sbufBytesRemaining	#
	movl	%eax, -40(%rbp)	# tmp176, len
	.loc 2 513 0
	movq	-72(%rbp), %rax	# cmd, tmp177
	movzwl	16(%rax), %eax	# cmd_15(D)->cmd, D.8952
	cmpw	$8, %ax	#, D.8952
	jle	.L62	#,
	.loc 2 513 0 is_stmt 0 discriminator 1
	movq	-72(%rbp), %rax	# cmd, tmp178
	movzwl	16(%rax), %eax	# cmd_15(D)->cmd, D.8952
	cmpw	$160, %ax	#, D.8952
	je	.L62	#,
	.loc 2 514 0 is_stmt 1
	movq	-72(%rbp), %rax	# cmd, tmp179
	movzwl	16(%rax), %eax	# cmd_15(D)->cmd, D.8952
	cwtl
	movl	%eax, %esi	# D.8953,
	movl	$.LC30, %edi	#,
...
.L66:
	.loc 2 548 0
	movq	buildDate(%rip), %rcx	# buildDate, D.8954
	...
	call	sbufWriteData	#
	.loc 2 549 0
	movq	buildTime(%rip), %rcx	# buildTime, D.8954
	...
	call	sbufWriteData	#
	.loc 2 550 0
	movq	shortGitRevision(%rip), %rcx	# shortGitRevision, D.8954
...
.L77:
	...
	.loc 2 556 0
	call	mixerConfig	#
	movzbl	(%rax), %eax	# _50->mixerMode, D.8956
	movzbl	%al, %edx	# D.8956, D.8953
...
.L64:
	.loc 2 563 0
	movzwl	cycleTime(%rip), %eax	# cycleTime, D.8957
	movzwl	%ax, %edx	# D.8957, D.8953
	...
	movl	$2, %edi	#,
	call	sensors	#
	movzbl	%al, %ebx	# D.8958, D.8959
	movl	$4, %edi	#,
	call	sensors	#
	movzbl	%al, %eax	# D.8958, D.8953
	addl	%eax, %eax	# D.8953
	orl	%eax, %ebx	# D.8959, D.8959
	movl	$8, %edi	#,
	call	sensors	#
	movzbl	%al, %eax	# D.8958, D.8953
	sall	$2, %eax	#, D.8953
	...
	call	sbufWriteU8	#
	.loc 2 572 0
	movzwl	averageSystemLoadPercent(%rip), %eax	# averageSystemLoadPercent, D.8957
	movzwl	%ax, %eax	# D.8957, D.8953
	movl	$100, %edx	#,
	movl	$0, %esi	#,
	movl	%eax, %edi	# D.8953,
	call	constrain	#
...
.LBB14:
	.loc 2 577 0
	movzwl	acc+16(%rip), %eax	# acc.acc_1G, D.8957
	cmpw	$1024, %ax	#, D.8957
	jbe	.L92	#,
...
.L93:
	...
	movl	%eax, -36(%rbp)	# D.8951, scale_shift
.LBB15:
...
.L95:
	...
	movzwl	accSmooth(%rax,%rax), %eax	# accSmooth, D.8952
	movswl	%ax, %edx	# D.8952, D.8953
	movl	-36(%rbp), %eax	# scale_shift, tmp208
	movl	%eax, %ecx	# tmp208, tmp249
	sarl	%cl, %edx	# tmp249, D.8953
	movl	%edx, %eax	# D.8953, D.8953
	movzwl	%ax, %edx	# D.8957, D.8953
	movq	-32(%rbp), %rax	# dst, tmp209
	movl	%edx, %esi	# D.8953,
	movq	%rax, %rdi	# tmp209,
	call	sbufWriteU16	#
...
.L97:
	...
	movl	-52(%rbp), %eax	# i, tmp210
	movl	gyroADC(,%rax,4), %eax	# gyroADC, D.8953
	movzwl	%ax, %edx	# D.8957, D.8953
...
.L99:
	...
	movl	-48(%rbp), %eax	# i, tmp212
	movl	magADC(,%rax,4), %eax	# magADC, D.8953
	movzwl	%ax, %edx	# D.8957, D.8953
...
.L90:
	.loc 2 624 0
	movq	accelerometerConfig(%rip), %rax	# accelerometerConfig, D.8960
	movzwl	2(%rax), %eax	# _140->accelerometerTrims.values.pitch, D.8952
	movzwl	%ax, %edx	# D.8957, D.8953
	...
	.loc 2 625 0
	movq	accelerometerConfig(%rip), %rax	# accelerometerConfig, D.8960
	movzwl	(%rax), %eax	# _145->accelerometerTrims.values.roll, D.8952
	movzwl	%ax, %edx	# D.8957, D.8953
...
.L85:
	...
	call	puts	#
	.loc 2 699 0
	movzbl	armingFlags(%rip), %eax	# armingFlags, D.8956
	movzbl	%al, %eax	# D.8956, D.8953
	andl	$4, %eax	#, D.8953
	testl	%eax, %eax	# D.8953
	jne	.L105	#,
	.loc 2 700 0
	movl	$400, %edi	#,
...
.L80:
	...
	movl	n.8623(%rip), %eax	# n, D.8953
	addl	$10, %eax	#, D.8953
	movl	%eax, n.8623(%rip)	# D.8953, n
	.loc 2 716 0
	jmp	.L91	#
.L83:
	.loc 2 733 0
	movq	-32(%rbp), %rax	# dst, tmp243
	movl	$0, %esi	#,
	movq	%rax, %rdi	# tmp243,
	call	sbufWriteU8	#
	.loc 2 734 0
	movq	-32(%rbp), %rax	# dst, tmp244
	movl	$65535, %esi	#,
	movq	%rax, %rdi	# tmp244,
	call	sbufWriteU16	#
	.loc 2 735 0
	movq	-32(%rbp), %rax	# dst, tmp245
	movl	$65535, %esi	#,
	movq	%rax, %rdi	# tmp245,
	call	sbufWriteU16	#
	.loc 2 737 0
	movq	-32(%rbp), %rax	# dst, tmp246
	movl	$65535, %esi	#,
	movq	%rax, %rdi	# tmp246,
	call	sbufWriteU16	#
	.loc 2 739 0
