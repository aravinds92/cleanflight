...
# 25 "./src/main/common/streambuf.h"
...
# 44 "src/main/msp/msp_serial.c" 2
...
# 45 "src/main/msp/msp_serial.c" 2

mspPostProcessFuncPtr mspPostProcessFn = 
# 46 "src/main/msp/msp_serial.c" 3 4
                                        ((void *)0)
# 46 "src/main/msp/msp_serial.c"
                                            ;
...
static mspPort_t* mspPortFindFree(void)
{
    for(int i = 0; i < 2; i++)
        if(mspPorts[i].port == 
# 62 "src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 62 "src/main/msp/msp_serial.c"
                                  )
            return &mspPorts[i];
    return 
# 64 "src/main/msp/msp_serial.c" 3 4
          ((void *)0)
# 64 "src/main/msp/msp_serial.c"
              ;
}
...
void mspSerialAllocatePorts(void)
{
    for(serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_MSP_SERVER | FUNCTION_MSP_CLIENT);
        portConfig != 
# 70 "src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 70 "src/main/msp/msp_serial.c"
                         ;
        ...
        if(mspPort == 
# 78 "src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 78 "src/main/msp/msp_serial.c"
                         ) {
...
# 97 "src/main/msp/msp_serial.c"
        serialPort_t *serialPort = openSerialPort(SERIAL_PORT_USB_VCP, function, 
# 97 "src/main/msp/msp_serial.c" 3 4
                                                                                ((void *)0)
# 97 "src/main/msp/msp_serial.c"
                                                                                    ,
...
# 115 "src/main/msp/msp_serial.c" 3 4
                                 ((void *)0)
# 115 "src/main/msp/msp_serial.c"
                                     );
        }
    }
}
...
{
    for(int i = 0; i < 2; i++) {
        resetMspPort(&mspPorts[i], 
# 123 "src/main/msp/msp_serial.c" 3 4
                                  ((void *)0)
# 123 "src/main/msp/msp_serial.c"
                                      );
    }
...
# 217 "src/main/msp/msp_serial.c"
static 
# 217 "src/main/msp/msp_serial.c" 3 4
      _Bool 
# 217 "src/main/msp/msp_serial.c"
           mspSerialProcessReceivedByte(mspPort_t *msp, uint8_t c)
{
        ...
        case IDLE:
            if (c != '$')
            {
                if(c == 'M')
                {
                    ...
                    return 
# 229 "src/main/msp/msp_serial.c" 3 4
                          1
# 229 "src/main/msp/msp_serial.c"
                              ;
                }
                return 
# 231 "src/main/msp/msp_serial.c" 3 4
                      0
# 231 "src/main/msp/msp_serial.c"
                           ;
            }
            msp->c_state = HEADER_M;
            break;
    ...
    return 
# 287 "src/main/msp/msp_serial.c" 3 4
          1
# 287 "src/main/msp/msp_serial.c"
              ;
}
...
# 304 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 304 "src/main/msp/msp_serial.c"
                consumed = mspSerialProcessReceivedByte(msp, c);
        ...
        if (mspPostProcessFn != 
# 330 "src/main/msp/msp_serial.c" 3 4
                               ((void *)0)
# 330 "src/main/msp/msp_serial.c"
                                   ) {
            mspPostProcessFn(msp);
            mspPostProcessFn = 
# 332 "src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 332 "src/main/msp/msp_serial.c"
                                  ;
        }
...
# 352 "src/main/msp/msp_serial.c" 3 4
           _Bool 
# 352 "src/main/msp/msp_serial.c"
                shouldSend = msp->commandSenderFn(command);
            ...
            msp->commandSenderFn = 
# 360 "src/main/msp/msp_serial.c" 3 4
                                  ((void *)0)
# 360 "src/main/msp/msp_serial.c"
                                      ;
        }

        fd = (int*)((void*)mspPorts[0].port + sizeof(serialPort_t));
        tcflush(*fd,
# 364 "src/main/msp/msp_serial.c" 3 4
                   2
# 364 "src/main/msp/msp_serial.c"
                            );
    }
}
