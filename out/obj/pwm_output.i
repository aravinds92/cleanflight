...
# 43 "/usr/include/mraa/gpio.h" 3 4
...
# 44 "/usr/include/mraa/gpio.h" 2 3 4
...
# 5 "./src/main/drivers/timer_setup.h" 2
...
# 22 "src/main/drivers/pwm_mapping.h" 2
...
# 26 "src/main/drivers/pwm_output.h" 3 4
_Bool 
# 26 "src/main/drivers/pwm_output.h"
    isMotorBrushed(uint16_t motorPwmRate);
...
# 35 "src/main/drivers/pwm_output.c" 2
# 44 "src/main/drivers/pwm_output.c"
...
static pwmOutputPort_t pwmOutputPorts[((4) > (1) ? (4) : (1))];

static pwmOutputPort_t *motors[4];
...
static 
# 65 "src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 65 "src/main/drivers/pwm_output.c"
           pwmMotorsEnabled = 
# 65 "src/main/drivers/pwm_output.c" 3 4
                              1
# 65 "src/main/drivers/pwm_output.c"
                                  ;
# 114 "src/main/drivers/pwm_output.c"
static pwmOutputPort_t *pwmOutConfig(uint32_t pin, uint16_t period, uint16_t value)
...
# 142 "src/main/drivers/pwm_output.c"
    return p;
}
...
void pwmWriteMotor(uint8_t index, uint16_t value)
{
    if (motors[index] && index < 4 && pwmMotorsEnabled)
...
{
    pwmMotorsEnabled = 
# 173 "src/main/drivers/pwm_output.c" 3 4
                      0
# 173 "src/main/drivers/pwm_output.c"
                           ;
}
...
{
    pwmMotorsEnabled = 
# 178 "src/main/drivers/pwm_output.c" 3 4
                      1
# 178 "src/main/drivers/pwm_output.c"
                          ;
}
# 202 "src/main/drivers/pwm_output.c"

# 202 "src/main/drivers/pwm_output.c" 3 4
_Bool 
# 202 "src/main/drivers/pwm_output.c"
    isMotorBrushed(uint16_t motorPwmRate)
{
