...
.LFB4:
	...
	movzwl	16(%rax), %edx	# command_2(D)->cmd, D.3973
	movq	-32(%rbp), %rax	# reply, tmp92
	movw	%dx, 16(%rax)	# D.3973, reply_4(D)->cmd
	.loc 1 49 0
	...
	movl	%eax, %edx	# tmp96, D.3973
	movq	-32(%rbp), %rax	# reply, tmp97
	movw	%dx, 18(%rax)	# D.3973, reply_4(D)->result
	.loc 1 52 0
	movl	-4(%rbp), %eax	# status, D.3974
	.loc 1 53 0
	leave
	.cfi_def_cfa 7, 8
	ret
