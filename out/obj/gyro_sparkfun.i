# 1 "src/main/drivers/gyro_sparkfun.c"
...
# 1 "<command-line>" 2
# 1 "src/main/drivers/gyro_sparkfun.c"
# 18 "src/main/drivers/gyro_sparkfun.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdbool.h" 1 3 4
# 19 "src/main/drivers/gyro_sparkfun.c" 2
...
# 20 "src/main/drivers/gyro_sparkfun.c" 2
...
# 22 "src/main/drivers/gyro_sparkfun.c" 2
# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 23 "src/main/drivers/gyro_sparkfun.c" 2
...
# 24 "src/main/drivers/gyro_sparkfun.c" 2
...
# 26 "src/main/drivers/gyro_sparkfun.c" 2
...
LSM9DS0_t* imu;
# 28 "src/main/drivers/gyro_sparkfun.c" 2
...
# 140 "src/main/drivers/gpio.h"
                                            enable);
# 29 "src/main/drivers/gyro_sparkfun.c" 2
# 1 "src/main/drivers/SFE_LSM9DS0.h" 1
# 30 "src/main/drivers/gyro_sparkfun.c" 2
...
# 33 "src/main/drivers/gyro_sparkfun.c" 2
...
# 34 "src/main/drivers/gyro_sparkfun.c" 2
# 69 "src/main/drivers/gyro_sparkfun.c"
extern LSM9DS0_t* imu;

static void sparkfun_gyro_init(uint8_t n)
{
# 91 "src/main/drivers/gyro_sparkfun.c"
}
# 129 "src/main/drivers/gyro_sparkfun.c"
static 
# 129 "src/main/drivers/gyro_sparkfun.c" 3 4
      _Bool 
# 129 "src/main/drivers/gyro_sparkfun.c"
           sparkfun_gyro_read(int16_t *gyroADC)
{
    ...
    gyroADC[1] = imu->gy;
    gyroADC[2] = imu->gz;
# 160 "src/main/drivers/gyro_sparkfun.c"
    return 
# 160 "src/main/drivers/gyro_sparkfun.c" 3 4
          1
# 160 "src/main/drivers/gyro_sparkfun.c"
              ;
}
...
# 166 "src/main/drivers/gyro_sparkfun.c" 3 4
_Bool 
# 166 "src/main/drivers/gyro_sparkfun.c"
    sparkfun_gyro_detect(gyro_t *gyro)
{
    gyro->init = sparkfun_gyro_init;
    gyro->read = sparkfun_gyro_read;

    gyro->scale = 0.07f;

    return 
# 173 "src/main/drivers/gyro_sparkfun.c" 3 4
          1
# 173 "src/main/drivers/gyro_sparkfun.c"
              ;
}
