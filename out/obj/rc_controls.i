...
# 59 "src/main/fc/rc_controls.c" 2
...
static 
# 72 "src/main/fc/rc_controls.c" 3 4
      _Bool 
# 72 "src/main/fc/rc_controls.c"
           isUsingSticksToArm = 
# 72 "src/main/fc/rc_controls.c" 3 4
                                1
# 72 "src/main/fc/rc_controls.c"
...
# 347 "src/main/fc/rc_controls.c" 3 4
_Bool 
# 347 "src/main/fc/rc_controls.c"
    rcModeIsActivationConditionPresent(modeActivationCondition_t *modeActivationConditions, boxId_e modeId)
{
    uint8_t index;
    ...
    for (index = 0; index < 20; index++) {
        ...
        if (modeActivationCondition->modeId == modeId && ((&modeActivationCondition->range)->startStep < (&modeActivationCondition->range)->endStep)) {
            return 
# 355 "src/main/fc/rc_controls.c" 3 4
                  1
# 355 "src/main/fc/rc_controls.c"
                      ;
        }
    }
    return 
# 358 "src/main/fc/rc_controls.c" 3 4
          0
# 358 "src/main/fc/rc_controls.c"
               ;
}



# 362 "src/main/fc/rc_controls.c" 3 4
_Bool 
# 362 "src/main/fc/rc_controls.c"
    rcModeIsActive(boxId_e modeId)
{
