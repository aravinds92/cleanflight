# 1 "src/main/drivers/compass_sparkfun.c"
...
# 1 "<command-line>" 2
# 1 "src/main/drivers/compass_sparkfun.c"
# 18 "src/main/drivers/compass_sparkfun.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdbool.h" 1 3 4
# 19 "src/main/drivers/compass_sparkfun.c" 2
...
# 20 "src/main/drivers/compass_sparkfun.c" 2
...
# 22 "src/main/drivers/compass_sparkfun.c" 2
...
# 24 "src/main/drivers/compass_sparkfun.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 26 "src/main/drivers/compass_sparkfun.c" 2
...
# 28 "src/main/drivers/compass_sparkfun.c" 2
...
# 29 "src/main/drivers/compass_sparkfun.c" 2
...
# 31 "src/main/drivers/compass_sparkfun.c" 2
...
# 33 "src/main/drivers/compass_sparkfun.c" 2
...
LSM9DS0_t* imu;
# 34 "src/main/drivers/compass_sparkfun.c" 2
...
# 140 "src/main/drivers/gpio.h"
                                            enable);
# 35 "src/main/drivers/compass_sparkfun.c" 2
...
# 36 "src/main/drivers/compass_sparkfun.c" 2
...
# 38 "src/main/drivers/compass_sparkfun.c" 2
# 67 "src/main/drivers/compass_sparkfun.c"
extern LSM9DS0_t* imu;


# 69 "src/main/drivers/compass_sparkfun.c" 3 4
_Bool 
# 69 "src/main/drivers/compass_sparkfun.c"
    sparkfun_init()
{
# 97 "src/main/drivers/compass_sparkfun.c"
    return 
# 97 "src/main/drivers/compass_sparkfun.c" 3 4
          1
# 97 "src/main/drivers/compass_sparkfun.c"
              ;
}
...
# 105 "src/main/drivers/compass_sparkfun.c" 3 4
_Bool 
# 105 "src/main/drivers/compass_sparkfun.c"
    sparkfun_read(int16_t *magData)
{
    ...
    magData[1] = imu->my;
    magData[2] = imu->mz;
# 146 "src/main/drivers/compass_sparkfun.c"
    return 
# 146 "src/main/drivers/compass_sparkfun.c" 3 4
          1
# 146 "src/main/drivers/compass_sparkfun.c"
              ;
}
...
# 150 "src/main/drivers/compass_sparkfun.c" 3 4
_Bool 
# 150 "src/main/drivers/compass_sparkfun.c"
    sparkfun_compass_Detect(mag_t *mag)
{
    mag->init = sparkfun_init;
    mag->read = sparkfun_read;
    return 
# 154 "src/main/drivers/compass_sparkfun.c" 3 4
          1
# 154 "src/main/drivers/compass_sparkfun.c"
              ;
}
