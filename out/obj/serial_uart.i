...
# 1 "<command-line>" 2
# 1 "src/main/drivers/serial_uart.c"
# 24 "src/main/drivers/serial_uart.c"
...
uint32_t U_ID_1;
uint32_t U_ID_2;
# 9 "./src/main/includes.h" 2
# 30 "src/main/drivers/serial_uart.c" 2

# 1 "src/main/drivers/serial_uart.h" 1
# 19 "src/main/drivers/serial_uart.h"
       
# 1 "./src/main/includes.h" 1

# 1 "/usr/include/errno.h" 1 3 4
# 3 "./src/main/includes.h" 2
# 21 "src/main/drivers/serial_uart.h" 2
...
# 22 "src/main/drivers/serial_uart.h" 2
# 44 "src/main/drivers/serial_uart.h"
...
# 68 "src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 68 "src/main/drivers/serial_uart.h"
        buffering;
} uartPort_t;
...
# 84 "src/main/drivers/serial_uart.h" 3 4
_Bool 
# 84 "src/main/drivers/serial_uart.h"
    usb_txbuffer_empty(serialPort_t *instance);
...
# 35 "src/main/drivers/serial_uart.c" 2
...
# 53 "src/main/drivers/serial_uart.c" 3 4
_Bool 
# 53 "src/main/drivers/serial_uart.c"
    data_available = 
# 53 "src/main/drivers/serial_uart.c" 3 4
...
# 54 "src/main/drivers/serial_uart.c" 3 4
_Bool 
# 54 "src/main/drivers/serial_uart.c"
    data_read = 
# 54 "src/main/drivers/serial_uart.c" 3 4
                1
# 54 "src/main/drivers/serial_uart.c"
...
static const struct serialPortVTable usbTable[] = {
    {
        ...
        .serialTotalRxWaiting = serial_waiting,
        ...
        .beginWrite = 
# 89 "src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 89 "src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 90 "src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 90 "src/main/drivers/serial_uart.c"
                       ,
        .writeBuf = 
# 91 "src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
    
# 92 "src/main/drivers/serial_uart.c"
   }
};
...
serialPort_t* usbInit(void)
{
    ...
    tcflush(fd,
# 110 "src/main/drivers/serial_uart.c" 3 4
              2
# 110 "src/main/drivers/serial_uart.c"
                       );
    SetUsbAttributes(fd);
    return &USB.port;
}
...
int usbOpen(void)
{
    int fd = open(portname, 
# 118 "src/main/drivers/serial_uart.c" 3 4
                           02 
# 118 "src/main/drivers/serial_uart.c"
                                  | 
# 118 "src/main/drivers/serial_uart.c" 3 4
                                    0400 
# 118 "src/main/drivers/serial_uart.c"
...
# 120 "src/main/drivers/serial_uart.c" 3 4
                                                           (*__errno_location ())
# 120 "src/main/drivers/serial_uart.c"
                                                                ));
        exit(
# 121 "src/main/drivers/serial_uart.c" 3 4
            1
# 121 "src/main/drivers/serial_uart.c"
                        );
    }
    USB.fd = fd;
...
# 134 "src/main/drivers/serial_uart.c" 3 4
                                                     (*__errno_location ())
# 134 "src/main/drivers/serial_uart.c"
                                                          ));
        exit(
# 135 "src/main/drivers/serial_uart.c" 3 4
            1
# 135 "src/main/drivers/serial_uart.c"
                        );
    }
    ...
    tty.c_cflag |= (
# 144 "src/main/drivers/serial_uart.c" 3 4
                   0004000 
# 144 "src/main/drivers/serial_uart.c"
                          | 
# 144 "src/main/drivers/serial_uart.c" 3 4
                            0000200
# 144 "src/main/drivers/serial_uart.c"
    ...
    tty.c_cflag &= ~
# 145 "src/main/drivers/serial_uart.c" 3 4
                   0000060
# 145 "src/main/drivers/serial_uart.c"
                        ;
    tty.c_cflag |= 
# 146 "src/main/drivers/serial_uart.c" 3 4
                  0000060
# 146 "src/main/drivers/serial_uart.c"
                     ;
    tty.c_cflag &= ~
# 147 "src/main/drivers/serial_uart.c" 3 4
                   0000400
# 147 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 148 "src/main/drivers/serial_uart.c" 3 4
                   0000100
# 148 "src/main/drivers/serial_uart.c"
                         ;
    tty.c_cflag &= ~
# 149 "src/main/drivers/serial_uart.c" 3 4
                   020000000000
# 149 "src/main/drivers/serial_uart.c"
                          ;

    if (tcsetattr(fd, 
# 151 "src/main/drivers/serial_uart.c" 3 4
                     0
# 151 "src/main/drivers/serial_uart.c"
                            , &tty) != 0) {
        printf("Error from tcsetattr: %s\n", strerror(
# 152 "src/main/drivers/serial_uart.c" 3 4
                                                     (*__errno_location ())
# 152 "src/main/drivers/serial_uart.c"
                                                          ));
        exit(
# 153 "src/main/drivers/serial_uart.c" 3 4
            1
# 153 "src/main/drivers/serial_uart.c"
                        );
    }
    return;
...
uint32_t usbWrite(uint8_t* str, int len)
{
    ...
    if(usbIsConnected() == 
# 163 "src/main/drivers/serial_uart.c" 3 4
                          0
# 163 "src/main/drivers/serial_uart.c"
                               )
    {
...
int32_t usbRead(uint8_t* buf, int len)
{
    ...
    else
    {
        ...
        {
            data_read = 
# 191 "src/main/drivers/serial_uart.c" 3 4
                       1
# 191 "src/main/drivers/serial_uart.c"
                           ;
            data_available = 
# 192 "src/main/drivers/serial_uart.c" 3 4
                            0
# 192 "src/main/drivers/serial_uart.c"
                                 ;
            return -1;
        }
    }
...
uint8_t usbIsConnected(void)
{
    if(USB.deviceState != UNCONNECTED)
        return 
# 201 "src/main/drivers/serial_uart.c" 3 4
              1
# 201 "src/main/drivers/serial_uart.c"
                  ;
    else
        return 
# 203 "src/main/drivers/serial_uart.c" 3 4
              0
# 203 "src/main/drivers/serial_uart.c"
                   ;
}
...
# 222 "src/main/drivers/serial_uart.c" 3 4
_Bool 
# 222 "src/main/drivers/serial_uart.c"
    usb_txbuffer_empty(serialPort_t *instance)
{
    return 
# 224 "src/main/drivers/serial_uart.c" 3 4
          1
# 224 "src/main/drivers/serial_uart.c"
              ;
}
...
# 243 "src/main/drivers/serial_uart.c" 3 4
   ((void) (((
# 243 "src/main/drivers/serial_uart.c"
   &readset
# 243 "src/main/drivers/serial_uart.c" 3 4
   )->__fds_bits)[((
# 243 "src/main/drivers/serial_uart.c"
...
# 243 "src/main/drivers/serial_uart.c"
    ...
    result = select(USB.fd + 1, &readset, 
# 248 "src/main/drivers/serial_uart.c" 3 4
                                         ((void *)0)
# 248 "src/main/drivers/serial_uart.c"
                                             , 
# 248 "src/main/drivers/serial_uart.c" 3 4
                                               ((void *)0)
# 248 "src/main/drivers/serial_uart.c"
    ...
    if(result > 0)
    {
        ...
        data_available = 
# 253 "src/main/drivers/serial_uart.c" 3 4
                        1
# 253 "src/main/drivers/serial_uart.c"
                            ;
        data_read = 
# 254 "src/main/drivers/serial_uart.c" 3 4
                   0
# 254 "src/main/drivers/serial_uart.c"
                        ;
        read_pos = 0;
    }
