...
.LFB13:
	...
	.loc 1 70 0
	movq	-8(%rbp), %rax	# instance, D.3598
	movq	%rax, %rdi	# D.3598,
...
accAlign:
	.zero	4
	.globl	calibratingA
	.section	.data.calibratingA,"aw",@progbits
	.align 2
	.type	calibratingA, @object
	.size	calibratingA, 2
calibratingA:
	.value	1
	.globl	acc_initialized
	.section	.bss.acc_initialized,"aw",@nobits
	.type	acc_initialized, @object
	.size	acc_initialized, 1
acc_initialized:
	.zero	1
...
.LFB15:
	...
	.cfi_def_cfa_register 6
	.loc 1 97 0
	movzwl	calibratingA(%rip), %eax	# calibratingA, D.3599
	testw	%ax, %ax	# D.3599
	sete	%al	#, D.3600
	.loc 1 98 0
	popq	%rbp	#
...
.LFB16:
	...
	.cfi_def_cfa_register 6
	.loc 1 102 0
	movzwl	calibratingA(%rip), %eax	# calibratingA, D.3601
	cmpw	$1, %ax	#, D.3601
	sete	%al	#, D.3602
	.loc 1 103 0
	popq	%rbp	#
...
.LFB17:
	...
	.cfi_def_cfa_register 6
	.loc 1 107 0
	movzwl	calibratingA(%rip), %eax	# calibratingA, D.3603
	cmpw	$400, %ax	#, D.3603
	sete	%al	#, D.3604
	.loc 1 108 0
	popq	%rbp	#
...
.L13:
	...
	je	.L12	#,
	.loc 1 119 0
	movzbl	-1(%rbp), %eax	# axis, D.3606
	cltq
	movl	$0, a.3404(,%rax,4)	#, a
.L12:
	.loc 1 122 0 discriminator 2
	movzbl	-1(%rbp), %ecx	# axis, D.3606
	movzbl	-1(%rbp), %eax	# axis, D.3606
	cltq
	movl	a.3404(,%rax,4), %edx	# a, D.3606
	movzbl	-1(%rbp), %eax	# axis, D.3606
	cltq
	movl	accADC(,%rax,4), %eax	# accADC, D.3606
	addl	%eax, %edx	# D.3606, D.3606
	movslq	%ecx, %rax	# D.3606, tmp123
	movl	%edx, a.3404(,%rax,4)	# D.3606, a
	.loc 1 125 0 discriminator 2
	movzbl	-1(%rbp), %eax	# axis, D.3606
	cltq
	movl	$0, accADC(,%rax,4)	#, accADC
	.loc 1 126 0 discriminator 2
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3607
	movzbl	-1(%rbp), %edx	# axis, D.3606
	movslq	%edx, %rdx	# D.3606, tmp125
	movw	$0, (%rax,%rdx,2)	#, _20->raw
	.loc 1 115 0 discriminator 2
	movzbl	-1(%rbp), %eax	# axis, D.3608
	addl	$1, %eax	#, tmp126
...
.L11:
	...
	je	.L14	#,
	.loc 1 131 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3607
	movl	a.3404(%rip), %eax	# a, D.3606
	leal	200(%rax), %ecx	#, D.3606
	movl	$1374389535, %edx	#, tmp128
	movl	%ecx, %eax	# D.3606, tmp140
	imull	%edx	# tmp128
	sarl	$7, %edx	#, tmp129
	movl	%ecx, %eax	# D.3606, tmp130
	sarl	$31, %eax	#, tmp130
	subl	%eax, %edx	# tmp130, D.3606
	movl	%edx, %eax	# D.3606, D.3606
	movw	%ax, (%rsi)	# D.3609, _27->raw
	.loc 1 132 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3607
	movl	a.3404+4(%rip), %eax	# a, D.3606
	leal	200(%rax), %ecx	#, D.3606
	movl	$1374389535, %edx	#, tmp132
	movl	%ecx, %eax	# D.3606, tmp141
	imull	%edx	# tmp132
	sarl	$7, %edx	#, tmp133
	movl	%ecx, %eax	# D.3606, tmp134
	sarl	$31, %eax	#, tmp134
	subl	%eax, %edx	# tmp134, D.3606
	movl	%edx, %eax	# D.3606, D.3606
	movw	%ax, 2(%rsi)	# D.3609, _33->raw
	.loc 1 133 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3607
	movl	a.3404+8(%rip), %eax	# a, D.3606
	leal	200(%rax), %ecx	#, D.3606
	movl	$1374389535, %edx	#, tmp136
	movl	%ecx, %eax	# D.3606, tmp142
	imull	%edx	# tmp136
	sarl	$7, %edx	#, tmp137
	movl	%ecx, %eax	# D.3606, tmp138
	sarl	$31, %eax	#, tmp138
	subl	%eax, %edx	# tmp138, D.3606
	movl	%edx, %eax	# D.3606, D.3606
	movl	%eax, %edx	# D.3606, D.3610
	movzwl	acc+16(%rip), %eax	# acc.acc_1G, D.3611
	subl	%eax, %edx	# D.3611, D.3610
	movl	%edx, %eax	# D.3610, D.3610
	movw	%ax, 4(%rsi)	# D.3609, _39->raw
	.loc 1 135 0
...
.L14:
	.loc 1 140 0
	movzwl	calibratingA(%rip), %eax	# calibratingA, D.3611
	subl	$1, %eax	#, D.3611
	movw	%ax, calibratingA(%rip)	# D.3611, calibratingA
	.loc 1 141 0
	nop
	leave
	.cfi_def_cfa 7, 8
...
.LFB19:
	...
	movq	%rdi, -24(%rbp)	# rollAndPitchTrims, rollAndPitchTrims
	.loc 1 151 0
	movzwl	InflightcalibratingA(%rip), %eax	# InflightcalibratingA, D.3612
	cmpw	$50, %ax	#, D.3612
	jne	.L16	#,
	.loc 1 152 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	(%rax), %eax	# _10->raw, D.3614
	movw	%ax, accZero_saved.3414(%rip)	# D.3614, accZero_saved
	.loc 1 153 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	2(%rax), %eax	# _13->raw, D.3614
	movw	%ax, accZero_saved.3414+2(%rip)	# D.3614, accZero_saved
	.loc 1 154 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	4(%rax), %eax	# _16->raw, D.3614
	movw	%ax, accZero_saved.3414+4(%rip)	# D.3614, accZero_saved
	.loc 1 155 0
	movq	-24(%rbp), %rax	# rollAndPitchTrims, tmp136
	movzwl	(%rax), %eax	# rollAndPitchTrims_19(D)->values.roll, D.3614
	movw	%ax, angleTrim_saved.3415(%rip)	# D.3614, angleTrim_saved.values.roll
	.loc 1 156 0
	movq	-24(%rbp), %rax	# rollAndPitchTrims, tmp137
	movzwl	2(%rax), %eax	# rollAndPitchTrims_19(D)->values.pitch, D.3614
	movw	%ax, angleTrim_saved.3415+2(%rip)	# D.3614, angleTrim_saved.values.pitch
.L16:
	.loc 1 158 0
	movzwl	InflightcalibratingA(%rip), %eax	# InflightcalibratingA, D.3612
	testw	%ax, %ax	# D.3612
...
.L20:
	...
	jne	.L19	#,
	.loc 1 162 0
	movzbl	-1(%rbp), %eax	# axis, D.3615
	cltq
	movl	$0, b.3413(,%rax,4)	#, b
.L19:
	.loc 1 164 0 discriminator 2
	movzbl	-1(%rbp), %ecx	# axis, D.3615
	movzbl	-1(%rbp), %eax	# axis, D.3615
	cltq
	movl	b.3413(,%rax,4), %edx	# b, D.3615
	movzbl	-1(%rbp), %eax	# axis, D.3615
	cltq
	movl	accADC(,%rax,4), %eax	# accADC, D.3615
	addl	%eax, %edx	# D.3615, D.3615
	movslq	%ecx, %rax	# D.3615, tmp141
	movl	%edx, b.3413(,%rax,4)	# D.3615, b
	...
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzbl	-1(%rbp), %edx	# axis, D.3615
	movslq	%edx, %rdx	# D.3615, tmp143
	movw	$0, (%rax,%rdx,2)	#, _38->raw
	.loc 1 159 0 discriminator 2
	movzbl	-1(%rbp), %eax	# axis, D.3616
	addl	$1, %eax	#, tmp144
...
.L18:
	...
	.loc 1 175 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	accZero_saved.3414(%rip), %edx	# accZero_saved, D.3614
	movw	%dx, (%rax)	# D.3614, _47->raw
	.loc 1 176 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	accZero_saved.3414+2(%rip), %edx	# accZero_saved, D.3614
	movw	%dx, 2(%rax)	# D.3614, _50->raw
	.loc 1 177 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3613
	movzwl	accZero_saved.3414+4(%rip), %edx	# accZero_saved, D.3614
	movw	%dx, 4(%rax)	# D.3614, _53->raw
	.loc 1 178 0
	movzwl	angleTrim_saved.3415(%rip), %edx	# angleTrim_saved.values.roll, D.3614
	movq	-24(%rbp), %rax	# rollAndPitchTrims, tmp145
	movw	%dx, (%rax)	# D.3614, rollAndPitchTrims_19(D)->values.roll
	.loc 1 179 0
	movzwl	angleTrim_saved.3415+2(%rip), %edx	# angleTrim_saved.values.pitch, D.3614
	movq	-24(%rbp), %rax	# rollAndPitchTrims, tmp146
	movw	%dx, 2(%rax)	# D.3614, rollAndPitchTrims_19(D)->values.pitch
.L21:
	.loc 1 181 0
	movzwl	InflightcalibratingA(%rip), %eax	# InflightcalibratingA, D.3612
	subl	$1, %eax	#, D.3612
	movw	%ax, InflightcalibratingA(%rip)	# D.3612, InflightcalibratingA
.L17:
	.loc 1 184 0
	movzbl	AccInflightCalibrationSavetoEEProm(%rip), %eax	# AccInflightCalibrationSavetoEEProm, D.3617
	testb	%al, %al	# D.3617
	je	.L23	#,
	.loc 1 185 0
	movb	$0, AccInflightCalibrationSavetoEEProm(%rip)	#, AccInflightCalibrationSavetoEEProm
	.loc 1 186 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3613
	movl	b.3413(%rip), %ecx	# b, D.3615
	movl	$1374389535, %edx	#, tmp148
	movl	%ecx, %eax	# D.3615, tmp160
	imull	%edx	# tmp148
	sarl	$4, %edx	#, tmp149
	movl	%ecx, %eax	# D.3615, tmp150
	sarl	$31, %eax	#, tmp150
	subl	%eax, %edx	# tmp150, D.3615
	movl	%edx, %eax	# D.3615, D.3615
	movw	%ax, (%rsi)	# D.3614, _66->raw
	.loc 1 187 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3613
	movl	b.3413+4(%rip), %ecx	# b, D.3615
	movl	$1374389535, %edx	#, tmp152
	movl	%ecx, %eax	# D.3615, tmp161
	imull	%edx	# tmp152
	sarl	$4, %edx	#, tmp153
	movl	%ecx, %eax	# D.3615, tmp154
	sarl	$31, %eax	#, tmp154
	subl	%eax, %edx	# tmp154, D.3615
	movl	%edx, %eax	# D.3615, D.3615
	movw	%ax, 2(%rsi)	# D.3614, _71->raw
	.loc 1 188 0
	movq	accelerationTrims(%rip), %rsi	# accelerationTrims, D.3613
	movl	b.3413+8(%rip), %ecx	# b, D.3615
	movl	$1374389535, %edx	#, tmp156
	movl	%ecx, %eax	# D.3615, tmp162
	imull	%edx	# tmp156
	sarl	$4, %edx	#, tmp157
	movl	%ecx, %eax	# D.3615, tmp158
	sarl	$31, %eax	#, tmp158
	subl	%eax, %edx	# tmp158, D.3615
	movl	%edx, %eax	# D.3615, D.3615
	movl	%eax, %edx	# D.3615, D.3618
	movzwl	acc+16(%rip), %eax	# acc.acc_1G, D.3612
	subl	%eax, %edx	# D.3612, D.3618
	movl	%edx, %eax	# D.3618, D.3618
	movw	%ax, 4(%rsi)	# D.3614, _76->raw
	.loc 1 190 0
...
.LFB20:
	...
	.loc 1 198 0
	movl	accADC(%rip), %edx	# accADC, D.3619
	movq	-8(%rbp), %rax	# accelerationTrims, tmp99
	movzwl	(%rax), %eax	# accelerationTrims_3(D)->raw, D.3620
	cwtl
	subl	%eax, %edx	# D.3619, D.3619
	movl	%edx, %eax	# D.3619, D.3619
	movl	%eax, accADC(%rip)	# D.3619, accADC
	.loc 1 199 0
	movl	accADC+4(%rip), %edx	# accADC, D.3619
	movq	-8(%rbp), %rax	# accelerationTrims, tmp100
	movzwl	2(%rax), %eax	# accelerationTrims_3(D)->raw, D.3620
	cwtl
	subl	%eax, %edx	# D.3619, D.3619
	movl	%edx, %eax	# D.3619, D.3619
	movl	%eax, accADC+4(%rip)	# D.3619, accADC
	.loc 1 200 0
	movl	accADC+8(%rip), %edx	# accADC, D.3619
	movq	-8(%rbp), %rax	# accelerationTrims, tmp101
	movzwl	4(%rax), %eax	# accelerationTrims_3(D)->raw, D.3620
	cwtl
	subl	%eax, %edx	# D.3619, D.3619
	movl	%edx, %eax	# D.3619, D.3619
	movl	%eax, accADC+8(%rip)	# D.3619, accADC
	.loc 1 201 0
	nop
	popq	%rbp	#
	.cfi_def_cfa 7, 8
...
.L27:
	...
	cltq
	leaq	(%rax,%rax), %rdx	#, D.3621
	movq	-24(%rbp), %rax	# accADCRaw, tmp93
	addq	%rdx, %rax	# D.3621, D.3622
	movzwl	(%rax), %eax	# *_8, D.3623
	movswl	%ax, %edx	# D.3623, D.3624
	movl	-4(%rbp), %eax	# axis, tmp95
	cltq
	movl	%edx, accADC(,%rax,4)	# D.3624, accADC
...
.LFB22:
	...
	movq	%rax, -8(%rbp)	# tmp105, D.3632
	xorl	%eax, %eax	# tmp105
	.loc 1 214 0
	movzbl	acc_initialized(%rip), %eax	# acc_initialized, D.3625
	xorl	$1, %eax	#, D.3625
	testb	%al, %al	# D.3625
	je	.L29	#,
	.loc 1 216 0
	movl	$6, %edi	#,
	call	malloc	#
	movq	%rax, accelerationTrims(%rip)	# D.3626, accelerationTrims
	.loc 1 217 0
	movb	$1, acc_initialized(%rip)	#, acc_initialized
.L29:
	.loc 1 222 0
	movq	acc+8(%rip), %rax	# acc.read, D.3627
	...
	.loc 1 228 0
	movl	accAlign(%rip), %eax	# accAlign, D.3628
	movzbl	%al, %eax	# D.3629, D.3630
	movl	%eax, %edx	# D.3630,
	movl	$accADC, %esi	#,
	movl	$accADC, %edi	#,
	call	alignSensors	#
...
.L33:
	.loc 1 238 0
	movq	accelerationTrims(%rip), %rax	# accelerationTrims, D.3631
	movq	%rax, %rdi	# D.3631,
...
.LFE23:
	...
	.section	.bss.a.3404,"aw",@nobits
	.align 8
	.type	a.3404, @object
	.size	a.3404, 12
a.3404:
	.zero	12
	.section	.bss.accZero_saved.3414,"aw",@nobits
	.align 2
	.type	accZero_saved.3414, @object
	.size	accZero_saved.3414, 6
accZero_saved.3414:
	.zero	6
	.section	.bss.angleTrim_saved.3415,"aw",@nobits
	.align 2
	.type	angleTrim_saved.3415, @object
	.size	angleTrim_saved.3415, 4
angleTrim_saved.3415:
	.zero	4
	.section	.bss.b.3413,"aw",@nobits
	.align 8
	.type	b.3413, @object
	.size	b.3413, 12
b.3413:
