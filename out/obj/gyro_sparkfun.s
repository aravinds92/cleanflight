...
.LFB7:
	...
	.loc 1 132 0
	movq	imu(%rip), %rax	# imu, D.4901
	movq	%rax, %rdi	# D.4901,
	call	readGyro	#
	.loc 1 134 0
	movq	imu(%rip), %rax	# imu, D.4901
	movzwl	(%rax), %edx	# _4->gx, D.4902
	movq	-8(%rbp), %rax	# gyroADC, tmp98
	movw	%dx, (%rax)	# D.4902, *gyroADC_6(D)
	.loc 1 135 0
	movq	-8(%rbp), %rax	# gyroADC, tmp99
	leaq	2(%rax), %rdx	#, D.4903
	movq	imu(%rip), %rax	# imu, D.4901
	movzwl	2(%rax), %eax	# _9->gy, D.4902
	movw	%ax, (%rdx)	# D.4902, *_8
	.loc 1 136 0
	movq	-8(%rbp), %rax	# gyroADC, tmp100
	leaq	4(%rax), %rdx	#, D.4903
	movq	imu(%rip), %rax	# imu, D.4901
	movzwl	4(%rax), %eax	# _13->gz, D.4902
	movw	%ax, (%rdx)	# D.4902, *_12
	.loc 1 160 0
	movl	$1, %eax	#, D.4904
	.loc 1 161 0
	leave
