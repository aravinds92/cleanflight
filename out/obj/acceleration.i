...
extern 
# 84 "src/main/sensors/acceleration.c" 3 4
      _Bool 
# 84 "src/main/sensors/acceleration.c"
           AccInflightCalibrationMeasurementDone;
extern 
# 85 "src/main/sensors/acceleration.c" 3 4
      _Bool 
# 85 "src/main/sensors/acceleration.c"
           AccInflightCalibrationSavetoEEProm;
extern 
# 86 "src/main/sensors/acceleration.c" 3 4
      _Bool 
# 86 "src/main/sensors/acceleration.c"
...
# 95 "src/main/sensors/acceleration.c" 3 4
_Bool 
# 95 "src/main/sensors/acceleration.c"
    isAccelerationCalibrationComplete(void)
{
...
# 100 "src/main/sensors/acceleration.c" 3 4
_Bool 
# 100 "src/main/sensors/acceleration.c"
...
# 105 "src/main/sensors/acceleration.c" 3 4
_Bool 
# 105 "src/main/sensors/acceleration.c"
...
void performInflightAccelerationCalibration(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    if (InflightcalibratingA > 0) {
        ...
        if (InflightcalibratingA == 1) {
            AccInflightCalibrationActive = 
# 171 "src/main/sensors/acceleration.c" 3 4
                                          0
# 171 "src/main/sensors/acceleration.c"
                                               ;
            AccInflightCalibrationMeasurementDone = 
# 172 "src/main/sensors/acceleration.c" 3 4
                                                   1
# 172 "src/main/sensors/acceleration.c"
                                                       ;
    ...
    if (AccInflightCalibrationSavetoEEProm) {
        AccInflightCalibrationSavetoEEProm = 
# 185 "src/main/sensors/acceleration.c" 3 4
                                            0
# 185 "src/main/sensors/acceleration.c"
                                                 ;
...
void updateAccelerationReadings(rollAndPitchTrims_t *rollAndPitchTrims)
{
    if(!acc_initialized)
    {
        ...
        acc_initialized = 
# 217 "src/main/sensors/acceleration.c" 3 4
                         1
# 217 "src/main/sensors/acceleration.c"
                             ;
    }
