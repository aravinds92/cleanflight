...
# 19 "./src/main/common/pilot.h"
typedef struct pilotConfig_s {
    uint8_t callsign[14 + 1];
} pilotConfig_t;

pilotConfig_t pilotConfig_System; static inline pilotConfig_t* pilotConfig(void) { return &pilotConfig_System; } struct _dummy;
# 41 "src/main/common/pilot.c" 2

extern const pilotConfig_t pgResetTemplate_pilotConfig; pilotConfig_t pilotConfig_System; extern const pgRegistry_t pilotConfig_Registry; const pgRegistry_t pilotConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 47 | (0 << 12), .size = sizeof(pilotConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&pilotConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_pilotConfig}, };

const pilotConfig_t pgResetTemplate_pilotConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .callsign = " CLEANFLIGHT! ", }
