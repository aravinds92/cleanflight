# 1 "src/main/drivers/acc_sparkfun.c"
...
# 1 "<command-line>" 2
# 1 "src/main/drivers/acc_sparkfun.c"
# 18 "src/main/drivers/acc_sparkfun.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdbool.h" 1 3 4
# 19 "src/main/drivers/acc_sparkfun.c" 2
...
# 20 "src/main/drivers/acc_sparkfun.c" 2
...
# 22 "src/main/drivers/acc_sparkfun.c" 2
...
LSM9DS0_t* imu;
# 24 "src/main/drivers/acc_sparkfun.c" 2
...
# 25 "src/main/drivers/acc_sparkfun.c" 2
...
# 27 "src/main/drivers/acc_sparkfun.c" 2
...
# 28 "src/main/drivers/acc_sparkfun.c" 2
# 1 "src/main/drivers/SFE_LSM9DS0.h" 1
# 29 "src/main/drivers/acc_sparkfun.c" 2
# 60 "src/main/drivers/acc_sparkfun.c"
static void sparkfun_Init(acc_t *acc);
static 
# 61 "src/main/drivers/acc_sparkfun.c" 3 4
      _Bool 
# 61 "src/main/drivers/acc_sparkfun.c"
           sparkfun_Read(int16_t *accelData);

static 
# 63 "src/main/drivers/acc_sparkfun.c" 3 4
      _Bool 
# 63 "src/main/drivers/acc_sparkfun.c"
           useFifo = 
# 63 "src/main/drivers/acc_sparkfun.c" 3 4
                     0
# 63 "src/main/drivers/acc_sparkfun.c"
...
static void sparkfun_acc_init(void)
{
# 82 "src/main/drivers/acc_sparkfun.c"
}

uint8_t acc_samples = 0;

static 
# 86 "src/main/drivers/acc_sparkfun.c" 3 4
      _Bool 
# 86 "src/main/drivers/acc_sparkfun.c"
           sparkfun_Read(int16_t *accelData)
{
    ...
    accelData[1] = imu->ay;
    accelData[2] = imu->az;
# 132 "src/main/drivers/acc_sparkfun.c"
    return 
# 132 "src/main/drivers/acc_sparkfun.c" 3 4
          1
# 132 "src/main/drivers/acc_sparkfun.c"
              ;
}
...
# 135 "src/main/drivers/acc_sparkfun.c" 3 4
_Bool 
# 135 "src/main/drivers/acc_sparkfun.c"
    sparkfun_acc_Detect(acc_t *acc)
{
    acc->init = sparkfun_acc_init;
    acc->read = sparkfun_Read;
    return 
# 139 "src/main/drivers/acc_sparkfun.c" 3 4
          1
# 139 "src/main/drivers/acc_sparkfun.c"
              ;
}
