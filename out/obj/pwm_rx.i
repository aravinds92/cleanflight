...
# 7 "./src/main/drivers/timer_setup.h" 2
# 18 "./src/main/drivers/timer_setup.h"
...
pwmRxConfig_t pwmRxConfig_System; static inline pwmRxConfig_t* pwmRxConfig(void) { return &pwmRxConfig_System; } struct _dummy;
...
# 41 "src/main/drivers/pwm_rx.h" 3 4
_Bool 
# 41 "src/main/drivers/pwm_rx.h"
...
# 61 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 61 "src/main/drivers/pwm_mapping.h"
        useParallelPWM;
    
# 62 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 62 "src/main/drivers/pwm_mapping.h"
        usePPM;
    
# 63 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 63 "src/main/drivers/pwm_mapping.h"
        useSerialRx;
    
# 64 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 64 "src/main/drivers/pwm_mapping.h"
        useRSSIADC;
    
# 65 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 65 "src/main/drivers/pwm_mapping.h"
        useCurrentMeterADC;
# 78 "src/main/drivers/pwm_mapping.h"
    
# 78 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 78 "src/main/drivers/pwm_mapping.h"
        useVbat;
    
# 79 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 79 "src/main/drivers/pwm_mapping.h"
        useOneshot;
    
# 80 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 80 "src/main/drivers/pwm_mapping.h"
        useSoftSerial;
    
# 81 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 81 "src/main/drivers/pwm_mapping.h"
        useLEDStrip;
# 91 "src/main/drivers/pwm_mapping.h"
    
# 91 "src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 91 "src/main/drivers/pwm_mapping.h"
        airplane;
...
typedef struct pwmIOConfiguration_s {
    ...
    pwmPortConfiguration_t ioConfigurations[11];
...
# 41 "src/main/drivers/pwm_rx.c" 2
# 56 "src/main/drivers/pwm_rx.c"
...
# 103 "src/main/drivers/pwm_rx.c" 3 4
   _Bool 
# 103 "src/main/drivers/pwm_rx.c"
            tracking;
    
# 104 "src/main/drivers/pwm_rx.c" 3 4
   _Bool 
# 104 "src/main/drivers/pwm_rx.c"
            overflowed;
} ppmDevice_t;

ppmDevice_t ppmDev;
# 118 "src/main/drivers/pwm_rx.c"

# 118 "src/main/drivers/pwm_rx.c" 3 4
_Bool 
# 118 "src/main/drivers/pwm_rx.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmInit(void)
{
    ...
    ppmDev.tracking = 
# 169 "src/main/drivers/pwm_rx.c" 3 4
                         0
# 169 "src/main/drivers/pwm_rx.c"
                              ;
    ppmDev.overflowed = 
# 170 "src/main/drivers/pwm_rx.c" 3 4
                         0
# 170 "src/main/drivers/pwm_rx.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 180 "src/main/drivers/pwm_rx.c" 3 4
                           1
# 180 "src/main/drivers/pwm_rx.c"
                               ;
    }
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 217 "src/main/drivers/pwm_rx.c" 3 4
                       0
# 217 "src/main/drivers/pwm_rx.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 271 "src/main/drivers/pwm_rx.c" 3 4
                           1
# 271 "src/main/drivers/pwm_rx.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 286 "src/main/drivers/pwm_rx.c" 3 4
                             0
# 286 "src/main/drivers/pwm_rx.c"
                                  ;
            for (i = 0; i < 12; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 296 "src/main/drivers/pwm_rx.c" 3 4
_Bool 
# 296 "src/main/drivers/pwm_rx.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 12; channel++) {
        if (captures[channel] != 0) {
            return 
# 301 "src/main/drivers/pwm_rx.c" 3 4
                  1
# 301 "src/main/drivers/pwm_rx.c"
                      ;
        }
    }
    return 
# 304 "src/main/drivers/pwm_rx.c" 3 4
          0
# 304 "src/main/drivers/pwm_rx.c"
               ;
}
...
# 310 "src/main/drivers/pwm_rx.c" 3 4
                                  __builtin_offsetof (
# 310 "src/main/drivers/pwm_rx.c"
                                  pwmInputPort_t
# 310 "src/main/drivers/pwm_rx.c" 3 4
                                  , 
# 310 "src/main/drivers/pwm_rx.c"
...
# 320 "src/main/drivers/pwm_rx.c" 3 4
                                  __builtin_offsetof (
# 320 "src/main/drivers/pwm_rx.c"
                                  pwmInputPort_t
# 320 "src/main/drivers/pwm_rx.c" 3 4
                                  , 
# 320 "src/main/drivers/pwm_rx.c"
...
void pwmInConfig(const timerHardware_t *timerHardwarePtr, uint8_t channel)
{
    ...
    pwmGPIOConfig(timerHardwarePtr->gpio, timerHardwarePtr->gpio->pin, timerHardwarePtr->gpio->mode);

    pwmICConfig(timerHardwarePtr->tim, timerHardwarePtr->channel, 0);


    start_timer(pwmEdgeCallback, period_to_freq(0x10000), (uint16_t)0x10000, PERIODIC);
...
void ppmInConfig(const timerHardware_t *timerHardwarePtr)
{
    ...
    start_timer(ppmEdgeCallback, period_to_freq(0x10000), (uint16_t)0x10000, PERIODIC);
