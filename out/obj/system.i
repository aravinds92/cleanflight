...
# 20 "./src/main/drivers/drivers_compass.h" 2
...
# 20 "./src/main/sensors/sensors.h" 2
...
{
    clock_gettime(
# 77 "src/main/drivers/system.c" 3 4
                 4
# 77 "src/main/drivers/system.c"
                      , &current);
...
void systemInit(void)
{
    ...
    clock_gettime(
# 121 "src/main/drivers/system.c" 3 4
                 4
# 121 "src/main/drivers/system.c"
                      , &start);
